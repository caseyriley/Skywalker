...
const SearchMenu = (props) => {
  return (
    <nav className={"search-menu-nav"}>
      ...
      <div className={`search-menu-nav__a ${props.searchMenuState === "infiniteScroll" ? "menu-item-4" : ""}`} onClick={() => props.setSearchMenuState("infiniteScroll")} ><span>Landsat pics</span></div>
      <div className={`search-menu-nav__a ${props.searchMenuState === "mars-weather" ? "menu-item-5" : ""}`} onClick={() => props.setSearchMenuState("mars-weather")} ><span>Mars Weather</span></div>
