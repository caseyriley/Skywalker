...
const SearchMenu = (props) => {
  return (
    <nav className={"search-menu-nav"}>
      ...
      <div className={`search-menu-nav__a ${props.searchMenuState === "ininiteScroll" ? "menu-item-4" : ""}`} onClick={() => props.setSearchMenuState("ininiteScroll")} ><span>infinite scroll</span></div>
