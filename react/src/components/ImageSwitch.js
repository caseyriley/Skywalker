    ...
    <>
      {(() => {
        switch (props.searchMenuState ? props.searchMenuState : "imageSearch") {
          ...
          case "infiniteScroll":
            return <SoundGallery audioError={props.audioError} openCloseState={props.openCloseState} setOpenCloseState={props.setOpenCloseState} audioLoading={props.audioLoading} lastAdioSearchElementRef={props.lastAdioSearchElementRef} allAudioResults={props.allAudioResults}/> 
          case "mars-weather":
