...
import ImageModalSizeSelect from './ImageModalSizeSelect';

const ImageSizeSelect = (props) => {
  
  return (
    <>
      {props.openCloseState ? <ImageModalSizeSelect modalImageSizeState={props.modalImageSizeState} setModalImageSizeState={props.setModalImageSizeState}/> : 
